    ...
    <div class="studentManager">
        ...
        <div class="container">
            ...
            <el-row type="flex" class="handle-box" justify="space-between">
                <!-- <el-col  :span="21"> -->
                <div>
                    <el-button type="primary" icon="delete" class="handle-del mr10" @click="delAll">新增学生</el-button>
                     <span>年级:</span>
                    ...
                    <el-button  icon="search" @click="search">重置</el-button>
                </div>
                <!-- </el-col> -->
                <!-- <el-col  :span="3"> -->
                <div>
                    <el-button type="primary" icon="delete" class="handle-del mr10" @click="delAll">批量删除</el-button>
                    <el-button type="primary" icon="delete" class="handle-del mr10" @click="delAll">批量导入</el-button>
                </div>
                <!-- </el-col> -->
            </el-row>
